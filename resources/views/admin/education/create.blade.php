...
<div class="mb-6">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-2 ml-16">Add a new educational qualification</p>
        </div>
    </div>
</div>
...
<div class="max-w-4xl">
    <div class="group relative">
        ...
        <div class="relative bg-white rounded-2xl shadow-xl hover:shadow-2xl transition duration-500">
            ...
            <form action="{{ route('admin.education.store') }}" method="POST" class="p-8">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea class="w-full px-4 py-3 border-2 border-purple-200 rounded-xl focus:ring-4 focus:ring-purple-200 focus:border-purple-500 transition @error('description') border-red-500 @enderror" 
                              ...
                              name="description" 
                              rows="4"
                              placeholder="Key courses, projects, achievements, etc.">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
