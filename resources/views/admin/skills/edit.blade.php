            ...
            <form action="{{ route('admin.skills.update', $skill) }}" method="POST" class="p-8">
                ...
                <div class="mb-6">
                    ...
                    <div class="text-center mt-3">
                        <span class="inline-block bg-gradient-to-r from-green-600 to-teal-600 text-white px-6 py-2 rounded-xl font-bold text-lg" id="percentageValue">{{ old('percentage', $skill->percentage) }}%</span>
                    </div>
                    @error('percentage')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
