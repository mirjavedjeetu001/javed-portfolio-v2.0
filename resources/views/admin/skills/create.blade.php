...
<div class="container-fluid">
    <div class="mb-4">
        <h1 class="h3">Add New Skill</h1>
        <p class="text-muted">Add a new technical or professional skill</p>
    </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.skills.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <small class="text-muted">If you don't see the category you need, it will be created automatically when you upload your resume.</small>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="range" class="form-range" id="proficiency" name="proficiency" 
                                   min="0" max="100" value="{{ old('proficiency', 50) }}" 
                                   oninput="document.getElementById('proficiencyValue').textContent = this.value + '%'">
                            <div class="text-center mt-2">
                                <span class="badge bg-primary fs-5" id="proficiencyValue">{{ old('proficiency', 50) }}%</span>
                            </div>
                            @error('proficiency')
