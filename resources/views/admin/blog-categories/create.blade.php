    ...
    <div class="bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 rounded-3xl shadow-2xl p-8 mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-purple-100 text-lg">Add a new category to organize your blog posts</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex gap-2 flex-wrap">
                        @foreach(['red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'purple', 'pink'] as $color)
                            <label class="cursor-pointer">
                                <input type="radio" name="color" value="{{ $color }}" class="hidden peer" {{ old('color') == $color ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <select name="icon" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-purple-500 focus:outline-none transition">
                        ...
                        <option value="fas fa-laptop-code" {{ old('icon') == 'fas fa-laptop-code' ? 'selected' : '' }}>💻 Code</option>
                        <option value="fas fa-heart" {{ old('icon') == 'fas fa-heart' ? 'selected' : '' }}>❤️ Heart</option>
                        <option value="fas fa-plane" {{ old('icon') == 'fas fa-plane' ? 'selected' : '' }}>✈️ Travel</option>
                        ...
                        <option value="fas fa-utensils" {{ old('icon') == 'fas fa-utensils' ? 'selected' : '' }}>🍴 Food</option>
                        <option value="fas fa-dumbbell" {{ old('icon') == 'fas fa-dumbbell' ? 'selected' : '' }}>💪 Fitness</option>
                        <option value="fas fa-lightbulb" {{ old('icon') == 'fas fa-lightbulb' ? 'selected' : '' }}>💡 Ideas</option>
                    </select>
                </div>
