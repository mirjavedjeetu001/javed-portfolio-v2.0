...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-gradient-to-r from-blue-600 via-cyan-500 to-teal-500 rounded-3xl shadow-2xl p-8 mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-cyan-100 text-lg">Update {{ $blog->title }}</p>
            </div>
    ...
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border-2 border-gray-100">
        ...
        <form action="{{ route('admin.blogs.update', $blog) }}" method="POST" enctype="multipart/form-data" class="p-8">
            @csrf
            @method('PUT')
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="excerpt" rows="3"
                            ...
                            placeholder="A brief summary of your post (shown in listings)">{{ old('excerpt', $blog->excerpt) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="20"
                            ...
                            placeholder="Write your amazing content here...">{{ old('content', $blog->content) }}</textarea>
                        @error('content')
                            <p class="text-red-500 text-sm mt-2 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i> {{ $message }}
                            </p>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-2xl border-2 border-gray-200">
                        ...
                        <div id="current-image" class="mt-3">
                            <img src="{{ asset($blog->featured_image) }}" alt="Current" class="w-full rounded-xl shadow-lg">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-2xl border-2 border-gray-200">
                        ...
                        <input type="url" name="social_link" value="{{ old('social_link', $blog->social_link) }}"
                            class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-blue-500 focus:outline-none transition"
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-2xl border-2 border-gray-200">
                        ...
                        <input type="datetime-local" name="published_at" value="{{ old('published_at', $blog->published_at ? $blog->published_at->format('Y-m-d\TH:i') : '') }}"
                            class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-blue-500 focus:outline-none transition">
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-cyan-50 p-4 rounded-2xl border-2 border-blue-200">
                        ...
                        <label class="flex items-center cursor-pointer group">
                            <div class="relative">
                                <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $blog->is_featured) ? 'checked' : '' }} class="sr-only peer">
